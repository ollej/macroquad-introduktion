    ...
    loop {
        ...
        match game_state {
            ...
            GameState::Playing => {
                ...
                // ANCHOR_END: ship_texture
                let enemy_frame = enemy_small_sprite.frame();
                // ANCHOR: enemy_small_texture
                ...
                // ANCHOR_END: enemy_small_texture
