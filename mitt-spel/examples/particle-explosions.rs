    ...
    loop {
        ...
        match game_state {
            ...
            GameState::Playing => {
                ...
                // ANCHOR: removeexplosions
                explosions.retain(|(explosion, _)| explosion.config.emitting);
                // ANCHOR_END: removeexplosions
                ...
                // ANCHOR: drawexplosion
                for (explosion, coords) in explosions.iter_mut() {
                    explosion.draw(*coords);
                }
                // ANCHOR_END: drawexplosion
                draw_text(
